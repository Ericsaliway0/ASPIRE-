...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='reactome_embedding/data/emb', help='Directory to save the data.')
    parser.add_argument('--output-file', type=str, default='reactome_embedding/data/emb/embeddings.pkl', help='File to save the embeddings')
    ...
    parser.add_argument('--in_feats', type=int, default=2, help='Number of input features.')
...
## python reactome_embedding/gnn_embedding.py --in_feats 128 --out_feats 128 --num_layers 4 --num_heads 1 --batch_size 1 --lr 0.01 --num_epochs 207 

## python embedding/gnn_embedding.py --in_feats 128 --out_feats 128 --num_layers 4 --num_heads 1 --batch_size 1 --lr 0.01 --num_epochs 207 
